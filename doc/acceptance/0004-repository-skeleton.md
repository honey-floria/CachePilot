...
- `pyproject.toml`：固定项目元数据、Python `3.11.13`、pytest/Ruff 入口与 CLI。
...
脚本会拒绝非 `3.11.13` 解释器，防止将其他运行时的结果混入基线。

## 本地证据与限制

当前开发机为 Python `3.9.6`，因此不能伪造 Python 基线通过；
