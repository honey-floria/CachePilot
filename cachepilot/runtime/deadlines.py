...
class RequestDeadlineManager:
    ...
    def __init__(
        ...
        release_resources: Callable[[str], bool],
        *,
    ...
    def track_queued(self, request_id: str, request_deadline_ms: int) -> None:
    ...
    def mark_executing(self, request_id: str) -> Optional[TimeoutEvent]:
    ...
    @staticmethod
    def _effective_deadline(tracked: _TrackedDeadline) -> int:
...
def _require_identifier(request_id: str) -> None:
